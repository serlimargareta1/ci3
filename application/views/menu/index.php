...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newMenuModal"></i> Add New Menu</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <button href="" class="btn btn-success btn-sm" data-toggle="modal" data-popup="tooltip" data-placement="top" title="Edit" data-target="#editmenu<?= $m['id']; ?>"></i> Edit</button>
                                <button onclick="hapusMenu('<?= base_url('menu/hapusmenu/') . $m['id']; ?>')" class="btn btn-danger btn-sm"></i> Delete</button>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
